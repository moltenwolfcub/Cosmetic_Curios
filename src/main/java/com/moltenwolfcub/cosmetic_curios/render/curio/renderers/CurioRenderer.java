package com.moltenwolfcub.cosmetic_curios.render.curio.renderers;
...
public class CurioRenderer implements ICurioRenderer{
    ...
    public CurioRenderer(String texturePath, HumanoidModel<LivingEntity> model) {
        this(new ResourceLocation(CosmeticCurios.MOD_ID, String.format("textures/curio/%s.png", texturePath)), model);
    }
